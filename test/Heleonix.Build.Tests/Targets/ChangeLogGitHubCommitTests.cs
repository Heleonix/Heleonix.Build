// <copyright file="ChangeLogGitHubCommitTests.cs" company="Heleonix - Hennadii Lutsyshyn">
...
{
    /// <summary>
    /// Tests the <see cref="ChangeLogGitHubCommitTests"/>.
    /// </summary>
    [MemberTest(Name = nameof(ChangeLogGitHubCommitTests))]
    public static void Execute()
    {
        ...
        Act(() =>
        {
            succeeded = MSBuildHelper.RunTestTarget("Hx_ChangeLog_GitHubCommit", simulator.SolutionDir, properties);
        });
