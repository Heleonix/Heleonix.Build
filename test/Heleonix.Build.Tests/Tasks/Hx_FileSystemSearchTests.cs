// <copyright file="Hx_FileSystemSearchTests.cs" company="Heleonix - Hennadii Lutsyshyn">
...
/// <summary>
/// Tests the <see cref="Hx_FileSystemSearch"/>.
/// </summary>
[ComponentTest(Type = typeof(Hx_FileSystemSearch))]
public static class Hx_FileSystemSearchTests
{
    /// <summary>
    /// Tests the <see cref="Hx_FileSystemSearch.ExecuteInternal"/>.
    /// </summary>
    [MemberTest(Name = nameof(Hx_FileSystemSearch.Execute))]
    public static void Execute()
    {
        Hx_FileSystemSearch task = null;
        var succeeded = false;
                    ...
                    And("search direction is not specified", () =>
                    {
                        ...
                        And("search options are specified", () =>
                        {
                            ...
                            Should("find the only 111aaa.txt file", () =>
                            {
                                ...
                                Assert.That(task.FoundFiles[0], Is.EqualTo(Path.Combine(rootDir, "1", "11", "111", "111aaa.txt")));
