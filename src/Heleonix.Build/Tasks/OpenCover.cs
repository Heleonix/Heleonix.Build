...
public class OpenCover : BaseTask
{
    ...
    /// </summary>
    [Required]
    public string OpenCoverExe { get; set; }
    ...
    /// </summary>
    [Required]
    public string CoverageResultFile { get; set; }
    ...
    protected override void ExecuteInternal()
    {
        ...
        var coverageResultDir = Path.GetDirectoryName(this.CoverageResultFile);
        ...
        this.TotalBranches = Convert.ToInt64(summary.Attribute("numBranchPoints").Value, InvariantInfo);
        this.VisitedBranches = Convert.ToInt64(summary.Attribute("visitedBranchPoints").Value, InvariantInfo);
        this.TotalClasses = Convert.ToInt64(summary.Attribute("numClasses").Value, InvariantInfo);
        this.VisitedClasses = Convert.ToInt64(summary.Attribute("visitedClasses").Value, InvariantInfo);
        this.TotalMethods = Convert.ToInt64(summary.Attribute("numMethods").Value, InvariantInfo);
        this.VisitedMethods = Convert.ToInt64(summary.Attribute("visitedMethods").Value, InvariantInfo);
        this.MinCyclomaticComplexity = Convert.ToInt32(summary.Attribute("minCyclomaticComplexity").Value, InvariantInfo);
        this.MaxCyclomaticComplexity = Convert.ToInt32(summary.Attribute("maxCyclomaticComplexity").Value, InvariantInfo);
